...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-slate-800">Perusahaan yang Ditolak</h1>
            <p class="text-slate-600 mt-1">Kelola perusahaan yang sudah ditolak</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200">
        ...
        @else
            <div class="p-12 text-center">
                ...
                <h3 class="text-lg font-semibold text-slate-800 mb-2">Tidak Ada Perusahaan yang Ditolak</h3>
                <p class="text-slate-600">Semua perusahaan dalam status pending atau approved</p>
            </div>
        @endif
    </div>
</div>
