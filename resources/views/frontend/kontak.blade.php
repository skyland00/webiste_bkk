        ...
        <div class="max-w-[1400px] mx-auto px-8 sm:px-16">
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div class="space-y-6">
                    ...
                    <!-- Card 1: Location -->
                    <div
                        class="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
                        <div class="flex items-start gap-6">
                            <div
                                class="flex-shrink-0 w-14 h-14 bg-[#F8BE09] rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform">
                    ...
                    <div class="bg-gradient-to-br from-[#122431] to-[#1a3345] rounded-2xl p-8 shadow-lg">
                        ...
                        <div class="space-y-5">
                            ...
                            <div class="flex items-center gap-4">
                                <div
                                    class="w-12 h-12 bg-[#F8BE09]/20 rounded-xl flex items-center justify-center flex-shrink-0">
                                    <i class="ri-phone-line text-xl text-[#F8BE09]"></i>
                                </div>
                                <div>
                                    <div class="text-sm text-gray-400 mb-1">Telepon</div>
                                    <a href="tel:+622341838330"
                                        class="text-white font-semibold hover:text-[#F8BE09] transition">
                                        +62 2341 838330
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:info@smkn1purwosari.sch.id"
                                        class="text-white font-semibold hover:text-[#F8BE09] transition break-all">
                            ...
                            <div class="flex items-center gap-4">
                                <div
                                    class="w-12 h-12 bg-[#25D366]/20 rounded-xl flex items-center justify-center flex-shrink-0">
                        ...
                        <div class="mt-8 pt-6 border-t border-white/10">
                            ...
                            <div class="flex gap-3">
                                <a href="#" target="_blank"
                                    class="w-10 h-10 bg-white/10 hover:bg-[#F8BE09] rounded-lg flex items-center justify-center transition-all group">
            ...
            <div class="space-y-3 max-w-4xl mx-auto">
                ...
                <div class="border border-gray-200 rounded-xl overflow-hidden" x-data="{ open: false }">
                    <button @click="open = !open"
                        class="w-full p-5 text-left flex items-center justify-between hover:bg-gray-50 transition">
                        <span class="font-bold text-[#122431]">Apa itu BKK SMKN 1 Purwosari?</span>
                        <i class="ri-arrow-down-s-line text-xl text-[#122431] transition-transform"
                            :class="open ? 'rotate-180' : ''"></i>
                    </button>
                    <div x-show="open" x-collapse class="px-5 pb-5 border-t border-gray-100">
                        <p class="text-[#4B5057] pt-4">
                            BKK adalah lembaga yang memberikan pelayanan kepada lulusan SMK dalam penempatan kerja dan
                ...
                <div class="border border-gray-200 rounded-xl overflow-hidden" x-data="{ open: false }">
                    ...
                    <div x-show="open" x-collapse class="px-5 pb-5 border-t border-gray-100">
                        <p class="text-[#4B5057] pt-4">
                            Daftar akun di website, browse lowongan yang tersedia, lalu klik "Lamar" pada lowongan yang
                            sesuai.
                        </p>
                    </div>
                </div>
