    ...
    <main class="flex-1 overflow-y-auto scrollbar-thin">
       ...
       <div class="w-full max-w-6xl pb-12 px-4">
            ...
            <nav class="flex items-center gap-2 text-sm text-slate-500 mb-8 ">
                ...
                <i class="ri-arrow-right-s-line text-xs"></i>
                <span class="text-slate-900">Buat Lowongan</span>
            </nav>

            {{-- Header --}}
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-slate-900 mb-2">Buat Lowongan Baru</h1>
                <p class="text-slate-600">Lengkapi informasi lowongan pekerjaan yang akan dipublikasikan</p>
            </div>
            ...
            <div class="bg-white rounded-lg border border-slate-200 shadow-sm w-full">
                ...
                <form action="{{ route('perusahaan.lowongan.store') }}" method="POST" class="p-7 space-y-8"
                    id="lowonganForm">
                    @csrf
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                <div>
                                    ...
                                    <select name="tipe_pekerjaan"
                                        ...
                                        <option value="kontrak" {{ old('tipe_pekerjaan') == 'kontrak' ? 'selected' : '' }}>
                                            Kontrak</option>
                                        <option value="magang" {{ old('tipe_pekerjaan') == 'magang' ? 'selected' : '' }}>
                                            Magang</option>
                                    </select>
                        ...
                        <div class="space-y-5">
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <input type="number" name="gaji_min" min="0" value="{{ old('gaji_min') }}"
                                        ...
                                        placeholder="Min (Rp)">
                                    <input type="number" name="gaji_max" min="0" value="{{ old('gaji_max') }}"
                                        class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:bg-white focus:border-slate-400 focus:ring-2 focus:ring-slate-200 transition-all"
                                        placeholder="Max (Rp)">
                                </div>
                            </div>
                        ...
                        <div class="space-y-5">
                            ...
                            <div>
                                ...
                                <textarea name="deskripsi_pekerjaan" rows="5"
                                    ...
                                    placeholder="Jelaskan tanggung jawab dan detail pekerjaan...">{{ old('deskripsi_pekerjaan') }}</textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="kualifikasi" rows="5"
                                    ...
                                    placeholder="Tulis kualifikasi, skill, dan pengalaman yang dibutuhkan...">{{ old('kualifikasi') }}</textarea>
                            </div>
                        </div>
                    </div>
